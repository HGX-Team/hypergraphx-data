...
## Source data
- GigaSheet: DC-MARVEL Comic Characters Dataset (https://www.gigasheet.com/sample-data/dc-marvel-comic-characters) and Marvel Universe Social Network Dataset (https://www.kaggle.com/datasets/csanhueza/the-marvel-universe-social-network?resource=download&select=edges.csv)
